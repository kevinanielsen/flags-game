...
const ConfirmModal: React.FC<TConfirmModal> = ({
  ...
  return (
    <div className="absolute w-screen h-screen top-0 left-0 bg-black/20 flex justify-center items-center">
      <div className="bg-white/95 dark:bg-slate-950/95 rounded shadow-lg border justify-center items-center flex flex-col m-4 p-8 w-full max-w-lg backdrop-filter">
